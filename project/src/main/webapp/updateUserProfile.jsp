		...
		<form action="update" method="post">
			<div class="form-row">
				...
				<div class="input-group">
					<label for="username">Username</label> <input type="text"
						id="username" name="username" value="${updateResult.username }" onchange="checkUserName()" required>
					<br> <span id="out_username"></span>
				</div>
				<div class="input-group">
					<label for="email">E-mail</label> <input type="email" id="email"
						name="email" value="${updateResult.email }" onchange="checkEmail(); " required> <br>
			...
			<div class="form-row">
				...
				<div class="input-group">
					<label for="contact">Contact Number</label> <input type="tel"
						id="contact" name="contact" value="${updateResult.contact }" onchange="checkContactNumber()"
						required> <br> 
				...
				<div class="input-group">
					<label for="password">Password</label> <input type="password"
						id="password" name="password" value="${updateResult.password }" required><br> <span
						id=""></span>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="input-group">
					<label for="aadhar">Aadhar Number</label> <input type="tel"
						id="aadhar" name="aadhar" value="${updateResult.aadhar }" onchange="checkAadharNumber()" required><br>
					<span id="out_aadhar"></span>
					<span id="aadharResponse"></span>
				</div>
				<div class="input-group">
					<label for="dob">Date Of Birth</label> <input type="date" id="dob"
						name="dob" value="${updateResult.dob }" required>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="input-group">
					...
					<input type="tel" id="alternativeContact" name="alternativeContact" value="${updateResult.alternativeContact }"
						required>
				</div>
				<div class="input-group">
					<label for="country">Country</label> <input type="text"
						id="country" name="country" value="India" value="${updateResult.country }" required>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="input-group">
					<label for="state">State</label> <input type="text" id="state"
						name="state" onchange="checkState()" value="${updateResult.state }" required><br> <span
						id="out_state"></span>
				</div>
				<div class="input-group">
					<label for="city">City</label> <input type="text" id="city"
						name="city" onchange="checkCity()" value="${updateResult.city }" required><br> <span
						id="out_city"></span>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="input-group">
					<label for="pincode">Pincode</label> <input type="number"
						id="pincode" name="pincode" onchange="checkPincode()" value="${updateResult.pincode }" required><br>
					<span id="out_pincode"></span>
				</div>
				<div class="input-group">
					<label for="address">Address</label> <input type="text"
						id="address" name="address" onchange="checkAddress()" value="${updateResult.address }" required><br>
